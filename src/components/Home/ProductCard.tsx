  ...
  return (
    <div className="flex flex-col rounded-2xl border bg-white shadow-lg">
      ...
      <div className="flex items-center justify-between rounded-b-2xl bg-white p-6">
        <div>
          <p className="text-xs font-semibold uppercase text-gray-400">{t('home.products.retailPrice')}</p>
          <p className="text-xl font-bold text-orange-500">${product?.buyNowPrice?.toLocaleString()}</p>
        </div>
