...
export const DocumentUpload = ({
  ...
  return (
    <div className="w-full">
      ...
      {/* Drop Zone */}
      <div
        className={`relative rounded-3xl border-2 border-dashed bg-white p-6 text-center transition-all dark:bg-black ${
          dragActive
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
              <span className="font-bold text-primary">{t('Click here')}</span> to upload documents
            </p>
