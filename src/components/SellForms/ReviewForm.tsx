  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-md transition-all duration-300 ease-in-out hover:-translate-y-1">
          {/* Header */}
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              {/* Orange Icon */}
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#fdad3e]">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-6">
            {/* Left Column */}
            <div>
              <p className="mb-1 text-sm text-gray-500">{t('sell.form.equipmentTitle')}</p>
        ...
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-md transition-all duration-300 ease-in-out hover:translate-y-1">
          ...
          {/* Content */}
          <div className="mb-6 grid grid-cols-3 gap-x-12 gap-y-6">
            {/* Left Column */}
            <div>
            ...
            <div className="scrollbar-hide flex gap-2 overflow-x-auto">
              {dummyImages.slice(0, 6).map((src, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-black/0 transition duration-300 group-hover:bg-black/10"></div>
                </div>
              ))}
        ...
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-md transition-all duration-300 ease-in-out hover:translate-y-1">
          ...
          <div className="mb-6 grid grid-cols-3 gap-x-12 gap-y-6">
            {/* Left Column */}
            <div>
              <p className="mb-1 text-sm text-gray-500">{t('sell.form.review.selectedOption')}</p>
              <p className="font-medium">Retail Range</p>
            </div>

            <div>
              <p className="mb-1 text-sm text-gray-500">{t('sell.form.review.priceRange')}</p>
              <p className="font-medium">$150,000-$175,000</p>
            </div>

            <div>
              <p className="mb-1 text-sm text-gray-500">{t('sell.form.review.confidence')}</p>
