...
const BuyNowDetailsPage = (): JSX.Element => {
            ...
            <div className='grid grid-cols-2 md:grid-cols-5 gap-4 lg:col-span-4'>
              {images.slice(0, 5).map((image, index) => (
                <div
                  ...
                  className={`aspect-video rounded-3xl overflow-hidden cursor-pointer transition-all ${
  ...
  '
          ...
          '
            ...
            {/* Location */}
            <section className='grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-6 mt-12'>
              <h3 className='text-xl font-bold pl-4 tracking-wide'>{t('auction.location')}</h3>
      ...
      '
              ...
              '
              >
                <h4 className='font-bold text-sm mb-2'>{t('product.details.documentation')}</h4>
